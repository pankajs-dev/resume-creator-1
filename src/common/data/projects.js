...
const projects = [
  {
    ...
    files: [
      { name: "Amberlla Landing.Zip", size: "3.25 MB", link: "#" },
      { name: "Amberlla Admin.Zip", size: "3.15 MB", link: "#" },
      { name: "Amberlla Logo.Zip", size: "2.02 MB", link: "#" },
