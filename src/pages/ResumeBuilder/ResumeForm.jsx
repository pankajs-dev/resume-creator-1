...
function ResumeForm({ onCancel, onSave, t }) {
  ...
  const handleSave = async () => {
    ...
    try {
      ...
      // ✅ EXPORT PDF/DOC API
      await fetch("http://localhost:8080/ords/demo123/resume/export", {
        method: "POST",
        headers: { "Content-Type": "application/json" },
        body: JSON.stringify({
          id: data.resume_id,
      ...
      Swal.fire({
        icon: "success",
        title: "Saved!",
        text: "Resume saved & export started",
        timer: 1500,
      ...
      Swal.fire({
        icon: "error",
        title: "Server Error",
        text: err.message || "Unable to save resume",
      });
    }
  };
