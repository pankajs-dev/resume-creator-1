    ...
    <div className="shadow-lg bg-white rounded-3 p-3">
      <div className="d-flex flex-column">
        <label
          ...
          className="fs-2 fw-bolder text-tale custom-focus px-1 mb-0 lh-sm"
        >
          {formData.name}
        </label>
        ...
        <div>
          ...
          <span
            contentEditable
            suppressContentEditableWarning
            onBlur={(e) => updateField("country", e.currentTarget.textContent)}
            className="text-dark fw-bold custom-focus  mb-0 lh-sm"
          >
        ...
        <label
          ...
          className="text-dark custom-focus px-1 mt-2 mb-2 lh-sm"
        >
          {formData.summary}
        </label>
      </div>
      ...
      <div className="d-flex flex-column">
        <label className="fs-5 text-tale fw-bold custom-focus px-1 lh-sm">
          Job Experience
        </label>
